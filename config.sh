...
pathAPKOrange="$pathRepoOrange/platforms/android/app/build/outputs/apk/debug/MiOrange-PLAY_STORE-debug.apk"
pathAPKAmena="$pathRepoAmena/platforms/android/app/build/outputs/apk/debug/MiAmena-PLAY_STORE-debug.apk"
